...
flags:= -Isrc -std=c++1z -Wall -Wno-error=unused-variable -Wfloat-conversion -Wsign-conversion -Wno-error=sign-conversion  -Wimplicit-fallthrough -Wno-return-type-c-linkage  -Werror -MMD
...
deps:=${build_dir}/src/graph/decompose.d ${build_dir}/src/graph/search.d ${build_dir}/src/root/newton.d ${build_dir}/src/linear/oper.d ${build_dir}/src/linear/matrix_view.d ${build_dir}/src/linear/lapack.d ${build_dir}/src/linear/utils.d ${build_dir}/src/linear/permute.d ${build_dir}/src/linear/vector_view.d ${build_dir}/src/linear/blas.d ${build_dir}/src/linear/solve.d ${build_dir}/src/linear/decomp.d ${build_dir}/src/powerflow/matpower_format.d ${build_dir}/src/powerflow/dcsolve.d ${build_dir}/src/powerflow/model.d ${build_dir}/src/powerflow/dcmodel.d ${build_dir}/src/powerflow/ieee_cdf.d ${build_dir}/src/powerflow/solve.d ${build_dir}/src/petrinet/reach.d ${build_dir}/src/petrinet/srn.d ${build_dir}/src/petrinet/srnreach.d ${build_dir}/src/petrinet/mkutils.d ${build_dir}/src/petrinet/petrinet.d ${build_dir}/src/petrinet/srnssolve.d ${build_dir}/src/splinear/oper.d ${build_dir}/src/splinear/eigen.d ${build_dir}/src/splinear/utils.d ${build_dir}/src/splinear/solve.d ${build_dir}/src/splinear/matrix.d ${build_dir}/test/main.d ${build_dir}/test/root/newton.d ${build_dir}/test/linear/matrix_view.d ${build_dir}/test/linear/blas.d ${build_dir}/test/linear/solve.d ${build_dir}/test/linear/decomp.d ${build_dir}/test/powerflow/dcsolve.d ${build_dir}/test/powerflow/model.d ${build_dir}/test/powerflow/solve.d ${build_dir}/test/petrinet/srn.d ${build_dir}/${gtest_dir}/src/gtest-all.d 
